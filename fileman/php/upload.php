...
//            $bfilePath = fixPath($path) . ".." . '/slide-' . $filename;
//            $sfilePath = fixPath($path) . ".." . '/carousel-' . $filename;
//            RoxyImage::CropCenter($filePath, $bfilePath, 448, 300);
//            RoxyImage::CropCenter($filePath, $sfilePath, 230, 180);
        }
        if ($errors && $errorsExt)
