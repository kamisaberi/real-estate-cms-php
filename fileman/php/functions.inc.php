...
//        $ret = "/School" . $ret; //return RoxyFile::FixPath($_SERVER['DOCUMENT_ROOT'] . FILES_ROOT . $_SESSION['User']);
//    }//else {
//        return $_SERVER['DOCUMENT_ROOT'] . FILES_ROOT . $_SESSION['User'];
//    }
    //return $_SERVER['DOCUMENT_ROOT'] . FILES_ROOT . "Admin";
    //$ret bayad masir nesbi bashad
    if ($_SESSION['UserType'] == 'Admin') {
        return $ret;
        //return BASE_URL_PATH . $ret;
    } elseif ($_SESSION['UserType'] == 'Teacher') {
        //return $_SERVER['DOCUMENT_ROOT'] . $ret . $_SESSION['User'];
        return $ret . "/" . $_SESSION['User'];
