...
if (isset($_GET['id'])) {
    ...
    $estateFacilityType = EstateFacilityTypeEx::GetOneEstateFacilityType($id);
    $name = $estateFacilityType->Name;
    $comment = $estateFacilityType->Comment;
}
//echo $estateFacilityType->Name;
?>
<form method="post" id="form1" name="form1" action="UpdateEstateFacilityType.php" >
