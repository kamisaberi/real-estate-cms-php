(function(f) {
    ...
    c.prototype.setVertPieces = function(H, O, P, K, N) {
        ...
        for (var L = 0; L < this._total; L++) {
            ...
            I.css({background: "url('" + R + "') no-repeat", backgroundPosition: M + "px " + Q + "px", opacity: P, top: O, width: K, "z-index": 3})
        }
    };
    c.prototype.animate = function(J, K) {
        ...
        this._intervalId = setInterval(function() {
            L._$stripes.eq(N).animate({top: 0, opacity: 1, width: L._size}, L._rotator._duration, L._rotator._easing, function() {
                if (f(this).attr("id") == I) {
    ...
    c.prototype.animateRandom = function(I) {
        ...
        var J = 0;
        this._intervalId = setInterval(function() {
            f(K._arr[H++]).animate({opacity: 1}, K._rotator._duration, K._rotator._easing, function() {
                if (++J == K._total) {
    ...
    w.prototype.setHorzPieces = function(H, L, O, Q, N) {
        ...
        for (var M = 0; M < this._total; M++) {
            ...
            I.css({background: "url('" + R + "') no-repeat", backgroundPosition: J + "px " + K + "px", opacity: O, left: L, height: Q, "z-index": 3})
        }
    };
    w.prototype.animate = function(I, J) {
        ...
        this._intervalId = setInterval(function() {
            K._$stripes.eq(M).animate({left: 0, opacity: 1, height: K._size}, K._rotator._duration, K._rotator._easing, function() {
                if (f(this).attr("id") == H) {
                    K._rotator.showContent(I)
                }
            });
    ...
    p.prototype.displayContent = function(H, I) {
        switch (I) {
            case l["diag.fade"]:
                ...
                this.diagAnimate(H, {opacity: 1}, false);
                break;
            case l["diag.exp"]:
                this.setBlocks(H, 0, 0, 0);
                this.diagAnimate(H, {opacity: 1, width: this._size, height: this._size}, false);
                break;
            case l["rev.diag.fade"]:
                this.setBlocks(H, 0, this._size, 0);
                this.diagAnimate(H, {opacity: 1}, true);
                break;
            case l["rev.diag.exp"]:
                this.setBlocks(H, 0, 0, 0);
                this.diagAnimate(H, {opacity: 1, width: this._size, height: this._size}, true);
                break;
            case l["block.fade"]:
                this.setBlocks(H, 0, this._size, 0);
    ...
    p.prototype.setBlocks = function(H, N, R, M) {
        ...
        for (var L = 0; L < this._numRows; L++) {
            for (var K = 0; K < this._numCols; K++) {
                ...
                this._$blockArr[L][K].css({background: "url('" + P + "') no-repeat", backgroundPosition: I + "px " + Q + "px", opacity: N, top: (L * this._size) + M, left: (K * this._size), width: R, height: R, "z-index": 3})
            }
        }
    };
    ...
    p.prototype.zigZag = function(I, P) {
        ...
        this._intervalId = setInterval(function() {
            O._$blockArr[N][L].animate({opacity: 1}, O._duration, O._rotator._easing, function() {
                if (f(this).attr("id") == K) {
    ...
    p.prototype.dirAnimate = function(J, K) {
        ...
        var L = this;
        this._intervalId = setInterval(function() {
            N[M++].animate({width: L._size, height: L._size}, L._rotator._duration, L._rotator._easing, function() {
                if (f(this).attr("id") == O) {
                    L._rotator.showContent(J)
                }
            });
    ...
    p.prototype.randomAnimate = function(I) {
        ...
        var J = this;
        this._intervalId = setInterval(function() {
            f(J._arr[H]).animate({top: f(J._arr[H]).data("top"), width: J._size, height: J._size, opacity: 1}, J._rotator._duration, J._rotator._easing, function() {
                if (++count == J._total) {
    ...
    p.prototype.spiral = function(H, P) {
        ...
        if (S.length > 0) {
            ...
            var Q = this;
            this._intervalId = setInterval(function() {
                S[K].animate({opacity: 1}, Q._rotator._duration, Q._rotator._easing, function() {
                    if (f(this).attr("id") == I) {
        ...
        if (this._displayThumbs || this._displayDBtns || this._displayPlayBtn) {
            if (this._cpPos == n) {
                ...
                if (this._cpMouseover) {
                    ...
                    this._$rotator.bind("mouseenter", {elem: this, dir: H}, this.displayCPanel).bind("mouseleave", {elem: this, dir: H}, this.hideCPanel)
                }
            } else {
                switch (m[this._cpAlign]) {
                    case m.BL:
    ...
    D.prototype.setInsideHP = function(J) {
        ...
        this._$cpanel.data({offset: I, pos: H}).css({top: (this._cpMouseover ? I : H)})
    };
    D.prototype.setInsideVP = function(J) {
        ...
        this._$cpanel.data({offset: I, pos: H}).css({left: (this._cpMouseover ? I : H)})
    };
    ...
    D.prototype.initButtons = function() {
        ...
        if (this._displayDBtns) {
            J.bind("click", {elem: this}, this.prevImg);
            K.bind("click", {elem: this}, this.nextImg)
        } else {
            J.hide();
            K.hide()
        }
        ...
        if (this._displaySideBtns) {
            ...
            this._$sPrev.bind("click", {elem: this}, this.prevImg).mousedown(q);
            this._$sNext.bind("click", {elem: this}, this.nextImg).mousedown(q);
            if (this._cpMouseover) {
        ...
        var I = this._$buttonPanel.find(">div").css({width: this._buttonWidth, height: this._buttonHeight}).mousedown(q);
        if (this._cpVertical) {
            J.addClass("up");
            K.addClass("down");
    ...
    D.prototype.initItems = function() {
        ...
        for (var N = 0; N < P; N++) {
            ...
            X.data({imgurl: K.attr("href"), caption: K.attr("title"), effect: M, delay: d(X.attr("delay"), this._globalDelay)});
        ...
        if (this._displayThumbs) {
            if (this._displayThumbImg) {
                ...
                for (var N = 0; N < J; N++) {
                    ...
                    if (I[0].complete || I[0].readyState == "complete") {
                        I.css({top: (this._thumbHeight - I.height()) / 2, left: (this._thumbWidth - I.width()) / 2})
                    } else {
                        I.load(function() {
                            f(this).css({top: (R._thumbHeight - f(this).height()) / 2, left: (R._thumbWidth - f(this).width()) / 2})
                        })
                    }
                }
            }
            this._$thumbs.css({width: this._thumbWidth, height: this._thumbHeight, "line-height": this._thumbHeight + "px"}).mousedown(q);
            ...
            if (this._cpVertical) {
                ...
                if (this._$thumbPanel.height() > V) {
                    ...
                    this._$thumbPanel.css({height: Math.floor(V / H) * H - this._margin, "margin-bottom": this._margin});
                    ...
                    W.css({height: H, width: "100%"});
                    S.css({height: H, width: "100%", top: "100%", "margin-top": -H});
                    if (!window.Touch) {
                        W.bind("mouseenter", function() {
                            S.show();
                            var Y = -R._$list.stop(true).position().top * A;
                            R._$list.stop(true).animate({top: 0}, Y, "linear", function() {
                                W.hide()
                            })
                        ...
                        S.bind("mouseenter", function() {
                            ...
                            R._$list.stop(true).animate({top: O}, Y, "linear", function() {
                                S.hide()
                            })
                        }).bind("mouseleave", {elem: this}, this.stopList)
                    } else {
                    ...
                    this._$rotator.bind(x, function() {
                        if (!R._$list.is(":animated")) {
                            ...
                            if (Y < 0 || Y > R._$thumbPanel.height() - R._$thumbs.outerHeight()) {
                                ...
                                R._$list.stop(true).animate({top: Y}, y, function() {
                                    if (!window.Touch) {
                ...
                if (this._$thumbPanel.width() > U) {
                    ...
                    this._$thumbPanel.css({width: Math.floor(U / H) * H - this._margin, "margin-right": this._margin});
                    var O = this._$thumbPanel.width() - (this._$list.width() - this._margin);
                    this._$thumbPanel.append("<div class='back-scroll'></div><div class='fwd-scroll'></div>");
                    var W = this._$thumbPanel.find(".back-scroll");
                    var S = this._$thumbPanel.find(".fwd-scroll");
                    W.css({width: H, height: "100%"});
                    S.css({width: H, height: "100%", left: "100%", "margin-left": -H});
                    if (!window.Touch) {
                        W.bind("mouseenter", function() {
                            S.show();
                            var Y = -R._$list.stop(true).position().left * A;
                            R._$list.stop(true).animate({left: 0}, Y, "linear", function() {
                                W.hide()
                            })
                        }).bind("mouseleave", {elem: this}, this.stopList);
                        S.bind("mouseenter", function() {
                            ...
                            R._$list.stop(true).animate({left: O}, Y, "linear", function() {
                                S.hide()
                            })
                        }).bind("mouseleave", {elem: this}, this.stopList)
                    }
                    this._$rotator.bind(x, function() {
                        if (!R._$list.is(":animated")) {
                            ...
                            if (Y < 0 || Y > R._$thumbPanel.width() - R._$thumbs.outerWidth()) {
                                ...
                                R._$list.stop(true).animate({left: Y}, y, function() {
    ...
    D.prototype.initTextData = function(H, J) {
        ...
        H.data("textbox", {x: I.css("left"), y: I.css("top"), w: L + J, h: K + J + 1, color: I.css("color"), bgcolor: I.css("background-color")})
    };
    ...
    D.prototype.showHImgTooltip = function(J) {
        ...
        if (H.attr("src")) {
            ...
            if (H[0].complete || H[0].readyState == "complete") {
                ...
                var K = f(this).offset();
                I._$tooltip.css({top: K.top + L, left: K.left + ((f(this).outerWidth() - I._$tooltip.outerWidth()) / 2)}).stop(true, true).delay(r).fadeIn(300)
            }
        }
    };
    D.prototype.showVImgTooltip = function(K) {
        ...
        if (H.attr("src")) {
            ...
            if (H[0].complete || H[0].readyState == "complete") {
                ...
                var L = f(this).offset();
                J._$tooltip.css({top: L.top + ((f(this).outerHeight() - J._$tooltip.outerHeight()) / 2), left: L.left + I}).stop(true, true).delay(r).fadeIn(300)
            }
        }
    };
    D.prototype.showTooltip = function(J) {
        ...
        if (H != "") {
            ...
            I._$tooltip.css({top: J.pageY + K, left: J.pageX}).stop(true, true).delay(r).fadeIn(300)
        }
    };
    D.prototype.moveTooltip = function(I) {
        var H = I.data.elem;
        var J = H._$tooltip.data("bottom") ? 0 : -H._$tooltip.outerHeight(true);
        H._$tooltip.css({top: I.pageY + J, left: I.pageX})
    };
    ...
    D.prototype.showSideButtons = function(I) {
        var H = I.data.elem;
        H._$sPrev.stop(true).animate({left: 0}, y);
        H._$sNext.stop(true).animate({"margin-left": -H._$sNext.width()}, y)
    };
    D.prototype.hideSideButtons = function(I) {
        var H = I.data.elem;
        H._$sPrev.stop(true).animate({left: -H._$sPrev.width()}, y);
        H._$sNext.stop(true).animate({"margin-left": 0}, y)
    };
    ...
    D.prototype.updateText = function(J) {
        ...
        if (!H._$textBox.data("visible")) {
            ...
            if (K && K.length > 0) {
                ...
                H._$textBox.find(".inner-bg").css({"background-color": I.bgcolor, height: I.h - 1});
                switch (C[H._textEffect]) {
                    case C.fade:
                        H.fadeInText(K, I);
                        break;
                    case C.down:
                        H.expandText(K, I, {width: I.w, height: 0}, {height: I.h});
                        break;
                    case C.right:
                        H.expandText(K, I, {width: 0, height: I.h}, {width: I.w});
                        break;
                    case C.left:
                        H.expandText(K, I, {"margin-left": I.w, width: 0, height: I.h}, {width: I.w, "margin-left": 0});
                        break;
                    case C.up:
                        H.expandText(K, I, {"margin-top": I.h, height: 0, width: I.w}, {height: I.h, "margin-top": 0});
                        break;
                    default:
                        H.showText(K, I)
                }
    ...
    D.prototype.expandText = function(L, K, J, H) {
        ...
        this._$textBox.stop(true, true).css({display: "block", top: K.y, left: K.x, "margin-top": 0, "margin-left": 0}).css(J).animate(H, y, function() {
    ...
    D.prototype.fadeInText = function(J, I) {
        ...
        this._$textBox.css({top: I.y, left: I.x, width: I.w, height: I.h}).stop(true, true).fadeIn(y, function() {
            if (jQuery.browser.msie) {
    ...
    D.prototype.showText = function(I, H) {
        this._$textBox.stop(true).css({display: "block", top: H.y, left: H.x, width: H.w, height: H.h});
        this._$innerText.html(I)
    };
    D.prototype.displayText = function(I) {
        var H = I.data.elem;
        H._$rotator.unbind(g).bind(g, {elem: H}, H.updateText).trigger(g)
    };
    ...
    D.prototype.loadContent = function(J) {
        ...
        if (this._$mainLink) {
            ...
            var H = L.attr("href");
            if (H) {
                this._$mainLink.unbind("click", q).css("cursor", "pointer").attr({href: H, target: L.attr("target")})
            } else {
    ...
    D.prototype.fadeInContent = function(H) {
        ...
        H.attr("id", "curr-img").stop(true, true).css({opacity: 0, "z-index": 1}).show().animate({opacity: 1}, this._duration, this._easing, function() {
    ...
    D.prototype.SlideContent = function(M, O, L) {
        ...
        if (H.size() > 0) {
            ...
            var N = (O == "top") ? {top: I} : {left: I};
            var K = this;
            this._$strip.stop(true, true).animate(N, this._duration, this._easing, function() {
                K._$strip.find(".main-img:not('#curr-img')").parents(".content-box").hide();
                K._$strip.find("#curr-img").parents(".content-box").show();
                J.parents(".content-box").css({top: 0, left: 0});
                K._$strip.css({top: 0, left: 0});
                if (K._textSync) {
    ...
    D.prototype.storeImg = function(J, K) {
        if (this._globalEffect == "h.Slide" || this._globalEffect == "v.Slide") {
            ...
            this.centerImg(K);
            var H = f("<div class='content-box'></div>").css({width: this._screenWidth, height: this._screenHeight});
            K.wrap(H);
            K.css("display", "block");
    ...
    D.prototype.centerImg = function(H) {
        if (this._autoCenter && H.width() > 0 && H.height() > 0) {
            H.css({top: (this._screenHeight - H.height()) / 2, left: (this._screenWidth - H.width()) / 2})
        }
    };
    D.prototype.startTimer = function() {
        if (this._rotate && this._timerId == null) {
            ...
            this._$timer.stop(true).animate({width: (this._screenWidth + 1)}, I, "linear");
